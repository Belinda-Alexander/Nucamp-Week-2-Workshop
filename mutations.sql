...
-- A: Add a column such as "expert_in" to record category_id of expertise.
...
-- Test your answer in pgAdmin or psql and verify that it worked correctly, then
-- place it in the blank space below.
INSERT INTO employees_categories (category_id, employee_id)
SELECT 
	(SELECT ca.category_id 
	FROM categories ca
	WHERE ca.category_name = 'Dairy Products'),
	e.employee_id 
	FROM employees e
	WHERE e.city = 'London';
